...
export function parseGeminiResponse(
    ...
    if (!uuid) {
      ...
      if (!productsResultMap.has(uuid)) {
        const productObj: Product = {
          ...
          tax: p.tax !== undefined && p.tax !== null ? p.tax : 0,
          taxPercentage: p.tax_percentage !== undefined && p.tax_percentage !== null ? p.tax_percentage : 0,
  ...
  safeInvoices.forEach(inv => {
      ...
      if (aiProdId) {
        ...
        if (!uuid) {
          ...
          const newProduct: Product = {
            ...
            tax: inv.tax_amount !== undefined && inv.tax_amount !== null ? inv.tax_amount : 0,
            taxPercentage: inv.tax_percentage !== undefined && inv.tax_percentage !== null ? inv.tax_percentage : 0,
      ...
      const invoiceObj: Invoice = {
        ...
        taxAmount: taxAmount !== undefined && taxAmount !== null ? taxAmount : 0,
        taxPercentage: finalTaxPercentage !== undefined && finalTaxPercentage !== null ? finalTaxPercentage : 0,
